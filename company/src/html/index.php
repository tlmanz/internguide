       ...
       <aside class="left-sidebar" data-sidebarbg="skin6">
        ...
        <div class="col-md-4 col-xl-3">
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    <div>
                        <h2 class="text-center" style="font-size: 100%;"><i class="fa fa-city f-center"></i></h2>
                    </div>
                    <h2 class="text-center"><span><?php echo $tot ?>&nbspCompanies</span></h2>
                    <p class="m-b-0" style="text-align: center;">Are In The System!</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    <div>
                        <h2 class="text-center" style="font-size: 100%;"><i class="fa fa-cogs f-center"></i></h2>
                    </div>
                    <h2 class="text-center">Access</h2>
                    <p class="m-b-0" style="text-align: center;">Student Management</p>
                </div>
            </div>
            </a>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-pink order-card">
                <div class="card-block">
                    ...
                    <h2 class="text-center">Access</h2>
                    <p class="m-b-0" style="text-align: center;">Company Management</p>
                </div>
            </div>
            </a>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Recently Joined Students and Companies</h4>
                                </div>
                                    ...
                                    <table class="table no-wrap v-middle mb-0">
                                        <thead>
                                            <tr class="border-0">
                                                ...
                                                <th class="border-0 font-14 font-weight-medium text-muted">View</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                    <!-- This is The Recently Joined Items Code -->
                                    <!-- ////////////////////////////////////// -->
                                    <!-- ////////////////Begin///////////////// -->
                                        <?php
                                        $sql = 'SELECT * FROM customer_account ORDER BY cid DESC LIMIT 3';
                                        ...
                                        while($row2 = mysqli_fetch_array($runsql2)){
                                            ...
                                            $location2 = $row2['image'];
                                            $photo2 = "../assets/".$location2; 
                                            echo "
                                            <tr>
                                                <td class='border-top-0 px-2 py-4'>
                                                    <div class='d-flex no-block align-items-center'>
                                                ...
                                                <td class='border-top-0 text-muted px-2 py-4 font-14'>Company</td>
                                                <td class='border-top-0 px-2 py-4'>
                                                    <div style='text-align:left;'>
                                                        <a>$date</a>
                                                    </div>
