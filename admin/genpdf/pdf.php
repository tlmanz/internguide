...
<?php
    ...
    $run = mysqli_query( $connection,$SQL) or trigger_error(mysqli_error($connection));
   ...
   // $pdf->Cell(80,10,'Employee List',1,0,'C');
    ...
    $pdf->Cell(195,10,"Employee Details",1,1,'C');
