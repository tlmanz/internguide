                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <div class="row">
                                                                <div class="col-md-5">
                                                                    <div class="form-group">
                                                                        <label class="col-md-8">NIC Number</label>
                                                                        <input type="text" class="form-control text-center"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-1">
                                                                    <div class="custom-control custom-radio">
                                                                        ...
                                                                        class="custom-control-input" value="m" <?php 
                                                                        if ($gender == "m"){
                                                                            echo "checked";} 
                                                                            else{
                                                                                echo "disabled";} 
                                                                            ...
                                                                            <div class="custom-control custom-radio">
                                                                                ...
                                                                                if ($gender == "f"){
                                                                                    ...
                                                                                    <div class="custom-control custom-radio">
                                                                                        ...
                                                                                        class="custom-control-input" value = 'n' <?php 
                                                                                        if ($gender == "n"){
                                                                                            echo "checked";} 
                                                                                            else{
                                                                                                echo "disabled";} 
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-6">
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                placeholder="GPA" min="0" max="4.2"value="<?php echo $gpa ?>" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-10">
                                                                                    <div class="row">
                                                                                        <div class="col-md-10">
                                                                                            <div class="form-group">
                                                                                                <input type="tel" class="form-control"
                                                                                                placeholder="URL.." value="<?php echo $linkedin ?>" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-10">
                                                                                    <div class="row">
                                                                                        <div class="col-md-10">
                                                                                            <div class="form-group">
                                                                                                <input type="tel" class="form-control"
                                                                                                placeholder="URL.." value="<?php echo $web ?>" readonly>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
