                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="text-align: center;">
                                <form action='../dist/php/admin_update.php' method='post' enctype='multipart/form-data'>
                                    <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="First Name"  name='id' value='<?php echo $id ?>' readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control text-center"
                                                            placeholder="Last Name" name='username' value='<?php echo $username?>' readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <a href='password_reset_admin.php?edit=<?php echo $edit_id ?>' class="form-control text-center">
