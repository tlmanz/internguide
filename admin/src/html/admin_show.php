                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div style="text-align: center;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control text-center"
                                                            placeholder="First Name" value='<?php echo $name ?>' readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control text-center"
                                                            placeholder="First Name" value='<?php echo $email ?>' readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control text-center"
                                                            placeholder="Last Name" value='<?php echo $phone?>' readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <br>
                                <a style='margin-left: 0%' href = 'admin_table.php' >
                                    <button class="btn btn-rounded btn-success"><i class='fa fa-arrow-left'></i>&nbspBack</button>
                                </a>
                                <a style='margin-left: 60%' href = "admin_edit.php?edit=<?php echo $edit_id?>" >
