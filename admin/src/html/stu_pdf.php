        ...
        <div class="page-wrapper">
            ...
            <div class="card bg-c-blue order-card">
                <div class="card-block">
                    ...
                    <h2 class="text-center"><span><?php echo $admin_count ?>&nbspAdmins</span></h2>
                    <p class="m-b-0" style="text-align: center;">Are Here!</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0" style="text-align: center;">Admin List!</p>
                </div>
            </div>
        </a>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0" style="text-align: center;">Admins</p>
                </div>
            </div>
            </a>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Recently Joined Admins</h4>
                                    <div class="ml-auto">
                                                ...
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                ...
                                                                height="45" /></div>
                                                        <div class="">
                                                            <h5 class="text-dark mb-0 font-16 font-weight-medium"><?php echo $name ?></h5>
