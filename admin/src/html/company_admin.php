        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-green order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0" style="text-align: center;">Company List!</p>
                </div>
            </div>
        </a>
        </div>
        ...
        <div class="col-md-4 col-xl-3">
            ...
            <div class="card bg-c-yellow order-card">
                <div class="card-block">
                    ...
                    <p class="m-b-0" style="text-align: center;">Companies</p>
                </div>
            </div>
            </a>
        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="card-title">Recently Joined Companies</h4>
                                </div>
