                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class= 'text-center'>
                                <img src='../assets/companyImages/default.png' alt='image' class='rounded-circle' height='150'
                                width="150">
                                <br><br>
                                <h3>Logo</h3>
                            </div>
                            ...
                            <div style="text-align: center;">
                                <form action='../dist/php/add_company.php' method='post' enctype='multipart/form-data'>
                                    <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control text-center"
                                                            placeholder="Company Name" name="name" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <textarea class="form-control" rows="3" placeholder="Introduction" name='intro' required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <textarea type='text' class="form-control" rows="3" placeholder="Address..." name='address' required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <textarea type='text' class="form-control" rows="3" placeholder="Vision" name='vision' required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <textarea type='text'class="form-control" rows="3" placeholder="Mission" name='mission' required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <textarea type='text' class="form-control" rows="3" placeholder="Description" name='description' required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-2">Field of Work</label>
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            ...
                                                            placeholder="Enter URL as www.exmple.com" name='linkedin' required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <input type="tel" class="form-control"
                                                            placeholder="Enter URL as www.exmple.com" name='pin' required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <input type="tel" class="form-control"
                                                            placeholder="Enter URL as www.exmple.com" name='twitter' required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-10">
                                                <div class="row">
                                                    <div class="col-md-10">
                                                        <div class="form-group">
                                                            <input type="tel" class="form-control"
                                                            placeholder="Enter URL as www.exmple.com" name='facebook' required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
